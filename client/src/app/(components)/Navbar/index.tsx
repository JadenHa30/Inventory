...
import { setIsDarkMode, setIsSidebarCollapse } from '@/app/state';
    ...
    <div className="flex justify-between item-center w-full mb-7">
      ...
      <div className='flex justify-between items-center gap-5'>
        ...
        <div className='relative'>
          <input type='search' placeholder='Search groups and products' className='pl-10 pr-4 py-2 w-50 md:w-80 border-2 border-gray-300 bg-white rounded-lg focus:outline-none focus:border-blue-500'/>
          <div className='absolute insert-y-0 left-0 top-0 pl-3 flex items-center pointer-events-none h-[100%]'>
      ...
      <div className='flex justify-between items-center gap-5'>
        <div className='hidden md:flex justify-between items-center gap-5'>
          ...
          <div className='flex items-center gap-3 cursor-pointer'>
            ...
            <span className='font-semibold'>Ed sheeran</span>
          </div>
        </div>
        <Link href='/settings'>
